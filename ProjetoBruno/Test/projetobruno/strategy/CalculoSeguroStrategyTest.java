...
public class CalculoSeguroStrategyTest {
    ...
    @Test
    public void testRF020_ExecutarCalculoEmpresarialFrotaComDesconto() {
    ...
    @Test
    public void testRF020_ExecutarCalculoCondutorJovemComRiscoAgravado() {
        CalculadoraSeguroContexto contexto = new CalculadoraSeguroContexto();
 ...
 *S
 * RF020 - Condutor Experiente
 * RF020 - Veículo Esportivo
 *
 * @author Jonata Vendola
 * @version 1.0
 */
    // ════════════════════════════════════════════════════════════
    // RF020 — CENÁRIO ALTERNATIVO
    // Cliente experiente recebe bônus
    // ════════════════════════════════════════════════════════════

    @Test
    public void rf020_deveAplicarBonusCondutorExperiente() {
    ...
    @Test
    public void rf020_deveAplicarAcrescimoVeiculoEsportivo() {
    ...
    // ════════════════════════════════════════════════════════════
    // RF020 — CENÁRIO DE EXCESSÃO
    // trata falha ao selecionar estratégia
    // ════════════════════════════════════════════════════════════

    @Test
public void rf020_deveImpedirExecucaoSemEstrategiaDefinida() {
...
@Test
public void rf020_deveRejeitarIdadeNegativa() {
 ...
 // RF038 — CENÁRIO VÁLIDO
    ...
    // =====================================================
    @Test
    public void testRF020_ExecutarCalculoBasicoDeRisco() {
        CalculadoraSeguroContexto contexto = new CalculadoraSeguroContexto();
        double valorBaseVeiculo = 1000.0;
        int quantidadeVeiculos = 1;
    ...
    // =====================================================
    @Test
    public void testRF020_ExecutarCalculoPremiumDeRisco() {
        CalculadoraSeguroContexto contexto = new CalculadoraSeguroContexto();
