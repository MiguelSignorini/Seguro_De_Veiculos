...
public class SeguroTest {
    ...
    /**
     * RF011 — Seguro base deve retornar o valor padrão
     * sem nenhuma cobertura adicional.
     */
    @Test
    public void rf011_seguroBase() {
     ...
     */
    @Test
    public void rf011_coberturaEmpilhada() {
    ...
    /**
     * RF06 — Sistema deve impedir a adição
    ...
    public void testRF037_VerificarSomaCorretaMultiplasCoberturas() {
        ...
        double valorTotalObtido = seguroCompleto.getPreco();
        double valorEsperado = 760.00; // Ajuste para o valor que a soma deles deve dar
